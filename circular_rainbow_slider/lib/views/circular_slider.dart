...
class _CircularSliderState extends State<CircularSlider> {
  ...
  Widget build(BuildContext context) {
    ...
    Size canvasSize = Size(screenSize.width, screenSize.width - screenSize.width / 10 * 3);
    Offset center = canvasSize.center(Offset.zero);
    Offset knobPos =
        toPolar(center - Offset(strokeWidth, strokeWidth), currentAngle + startAngle, radius);
